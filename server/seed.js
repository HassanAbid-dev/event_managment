...
const events = [
  ...
  },
  {
    ...
    description: "Experience an unforgettable night of EDM, techno, and dazzling light shows.",
  ...
  },
  {
    ...
    description: "A premium gathering of CEOs, founders, and investors.",
  ...
  },
  {
    ...
    description: "Discover breathtaking contemporary and modern arts.",
  ...
  },
  {
    ...
    description: "Watch 25 startups pitch for 1 million dollars in seed funding.",
  ...
  },
  {
    ...
    description: "A technical breakdown of scalable cloud solutions.",
...
const seedDatabase = async () => {
  try {
    ...
    // hash passwords and mark all as verified
    const salt = await bcrypt.genSalt(10);
    const hashedUsers = users.map((u) => ({
      ...u,
      password: bcrypt.hashSync(u.password, salt),
      isverified: true, // ← matches your schema field name
    }));
    ...
    for (const event of createdEvents) {
      ...
      for (const user of selectedUsers) {
        ...
        // deduct seat for confirmed bookings
        if (status === "confirmed") {
